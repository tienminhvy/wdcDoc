                ...
                default: // nếu ko
                    ...
                    if ($db->checkDbConnection() == false) { // nếu kết nối lỗi
                        ...
                        if (checkSiteName($sitename) && checkSiteEmail($site_email) && $adminUserChecking->checkUsername() && $adminUserChecking->checkEmail() && $adminUserChecking->checkPassword()) {
                            ...
                            $db->insertTable('posts', 'title, content, author, date', 'Welcome to your first post!', 'Thanks you for using wdcDoc!', "'$admin_username'", '2020-04-26 00:00:00');
                            $db->insertTable('categories', 'title, slug, content, author, date', 'Uncategorized', 'uncategorized','This is the default category.', "'$admin_username'", '2020-04-26 00:00:00');
