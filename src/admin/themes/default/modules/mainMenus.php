    ...
    <nav id="wdc_ad_nav2">
        <ul>
            ...
            <li id="wdc_admin_create">
                <a href="<?php echo $site_addr.'/admin/create.php?request=create&type=posts' ?>"><i class="fi-xnsuxl-edit-solid"></i><span>Pages / Posts</span></a>
                <ul>
                    <li class="create posts"><a href="<?php echo $site_addr.'/admin/create.php?request=create&type=posts'?>">Create post</a></li>
                    <li class="view posts"><a href="<?php echo $site_addr.'/admin/create.php?request=view&type=posts' ?>">View posts</a></li>
                    <li class="create pages"><a href="<?php echo $site_addr.'/admin/create.php?request=create&type=pages' ?>">Create page</a></li>
                    <li class="view pages"><a href="<?php echo $site_addr.'/admin/create.php?request=view&type=pages' ?>">View pages</a></li>
                    <li class="create categories"><a href="<?php echo $site_addr.'/admin/create.php?request=create&type=categories' ?>">Create category</a></li>
                    <li class="view categories"><a href="<?php echo $site_addr.'/admin/create.php?request=view&type=categories' ?>">View categories</a></li>
                </ul>
            </li>
