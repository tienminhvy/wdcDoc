    ...
    <nav id="wdc_ad_nav2">
        <ul>
            ...
            <li id="wdc_admin_create">
                ...
                <ul>
                    <li class="create post"><a href="<?php echo $site_addr.'/admin/operation.php?request=create&type=posts'?>">Create post</a></li>
                    <li class="view posts"><a href="<?php echo $site_addr.'/admin/operation.php?request=view&type=posts' ?>">View posts</a></li>
                    <li class="create page"><a href="<?php echo $site_addr.'/admin/operation.php?request=create&type=pages' ?>">Create page</a></li>
                    <li class="view pages"><a href="<?php echo $site_addr.'/admin/operation.php?request=view&type=pages' ?>">View pages</a></li>
                    <li class="create category"><a href="<?php echo $site_addr.'/admin/operation.php?request=create&type=categories' ?>">Create category</a></li>
